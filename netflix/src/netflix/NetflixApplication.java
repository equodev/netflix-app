...
public class NetflixApplication implements IEquoApplication {
	private static final Logger logger = LoggerFactory.getLogger(NetflixApplication.class);
	...
	public EquoApplicationBuilder buildApp(EquoApplicationBuilder appBuilder) {
		try {
			...
			logger.error("Error obtaining profile ID", e);
		}
		return appBuilder
	...
	private void saveCurrentProfileIdToFile() {
		if (currentProfileId != null) {
			...
			try (PrintWriter out = new PrintWriter(currentProfileIdPath)) {
				...
				logger.error("Error loading current profile", e);
			}
		}
	}
